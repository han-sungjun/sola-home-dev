...
function releaseDetailModalBodyScrollClasses(){
 try{
   document.documentElement.classList.remove('upick-modal-open','upick-modal-lock','upick-modal-hard-lock','upick-v9-modal-lock');
   document.body.classList.remove('upick-modal-open','upick-modal-lock','upick-modal-hard-lock','upick-v9-modal-lock');
   document.body.style.position = '';
   document.body.style.top = '';
   document.body.style.left = '';
   document.body.style.right = '';
