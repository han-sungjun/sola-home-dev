...
(function(){
  ...
  function getOrCreateFilterSheet(){
    ...
    else (document.getElementById('duSheetRoot') || document.body).appendChild(sheet);
  ...
  function openDuFilterSheet(type){
    ...
    closeFilterPopovers();
    if(window.DuLayer && typeof window.DuLayer.mount === 'function') window.DuLayer.mount(sheet, 'sheet');
    else if(!sheet.closest('#duSheetRoot')) (document.getElementById('duSheetRoot') || document.body).appendChild(sheet);
